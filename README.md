...
I have prepared the 3 docker images: loratech_postgres, loratech_webapi, loratech_mongo according to question requirements. For the first step we should need to git clone all the source codes and data transform scripts in / or c:\\. It will create a C:\LoraTechTest folder.
